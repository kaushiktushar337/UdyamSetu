...
-- ISES city/sector contextual metrics. TEXT location_id keeps this table
-- compatible with deployments whose existing location_reference uses integer
-- IDs as well as deployments using UUID IDs.
CREATE TABLE IF NOT EXISTS ises_city_sector_metrics (
    metric_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    location_id TEXT NOT NULL,
    city VARCHAR(100) NOT NULL,
    sector VARCHAR(30) NOT NULL CHECK (sector IN ('Production', 'Retail', 'Other Services')),
